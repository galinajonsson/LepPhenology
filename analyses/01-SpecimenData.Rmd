...
Erynnis_tages <- subset(NHMcleanUniVol, species == "Erynnis tages")
...
library("raster")
r = stack("/Users/galinajonsson/Downloads/tas_hadukgrid_uk_5km_mon_190001-190012.nc")

test <- as.data.frame(r, row.names=NULL, optional=TRUE, xy=TRUE, 
              na.rm=FALSE)
